...
export class productRule extends Rule{
...
export class UserRule extends Rule{
...
export class ShoppingRule extends Rule {
...
//  apiClientHttp.addNewBuyRule(combineMap) return : value == rule id!!
...
// const sendRulesResponse = await apiClientHttp.addNewBuyRule(rule);
console.log(rule1)
console.log(rule2)
console.log(rule3)
console.log(rule4)
...
// "UserRule" :{ "uuid":"1", "storeId": "1", "userEmail": "1" }
